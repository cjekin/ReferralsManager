# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-10-08 23:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='referralsmanager.Form')),
                ('loc1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='loc1', to='referralsmanager.Locations')),
                ('loc2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='loc2', to='referralsmanager.Locations')),
                ('loinc', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='referralsmanager.LOINC')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tfcs', models.ManyToManyField(through='referralsmanager.Flat', to='referralsmanager.Form')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='labguide',
            name='mapid',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='referralsmanager.Map'),
        ),
        migrations.AddField(
            model_name='group',
            name='members',
        ...
        migrations.AddField(
            model_name='form',
            name='ref',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='referralsmanager.Reflabs'),
        ),
        migrations.AddField(
            model_name='flat',
            name='tfc',
        ...
        migrations.AddField(
            model_name='article',
            name='publications',
            field=models.ManyToManyField(to='referralsmanager.Publication'),
        ),
